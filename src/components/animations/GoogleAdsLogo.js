...
class GoogleAdsLogo extends React.Component {
  render() {
    return (
      <div className="logo" >
        <svg width="100" height="132" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
     viewBox="0 0 250.9 312.8" style={{enableBackground: "new 0 0 250.9 312.8"}} >
        <g>
          <path style={{fill:"#3C8BD9"}} className="st0" d="M85.9,28.6c2.4-6.3,5.7-12.1,10.6-16.8c19.6-19.1,52-14.3,65.3,9.7c10,18.2,20.6,36,30.9,54
          ...
          <path style={{fill:"#FABC04"}} className="st1" d="M85.9,28.6c-0.9,3.6-1.7,7.2-1.9,11c-0.3,8.4,1.8,16.2,6,23.5C101,82,112,101,122.9,120c1,1.7,1.8,3.4,2.8,5
          ...
          <path style={{fill:"#34A852"}} className="st2" d="M11.8,158c1.9-1.7,3.7-3.5,5.7-5.1c24.3-19.2,60.8-5.3,66.1,25.1c1.3,7.3,0.6,14.3-1.6,21.3
          ...
          <path style={{fill:"#FABC04"}} className="st1" d="M11.8,158c-0.4,0.4-0.4,1.1-1.1,1.2c-0.1-0.7,0.3-1.1,0.7-1.6L11.8,158"/>
          <path style={{fill:"#E1C025"}} className="st3" d="M81.6,201c-0.4-0.7,0-1.2,0.4-1.7c0.1,0.1,0.3,0.3,0.4,0.4L81.6,201"/>
          <path style={{fill:"#FFF"}} className="st4" d="M20.7,260.4C9.4,260.4,0,269.5,0,280.7c0,11.2,9.4,20.2,20.7,20.2c6.1,0,10.6-2,14.2-5.7
          ...
          <path style={{fill:"#FFF"}} className="st4" d="M170.4,300l13.2-35.1h5.1l13.2,35.1h-5l-3.4-9.5h-14.7l-3.4,9.5H170.4z M180.3,286.3H192l-5.7-15.8h-0.2
            L180.3,286.3z"/>
          <path style={{fill:"#FFF"}} className="st4" d="M206.5,297.1c-2.2-2.5-3.3-5.5-3.3-9.1c0-3.5,1.1-6.5,3.3-9.1c2.3-2.5,4.9-3.7,8.1-3.7c1.8,0,3.4,0.4,4.8,1.1
          ...
          <path style={{fill:"#FFF"}} className="st4" d="M248.1,298.6c-1.8,1.4-4.1,2.2-6.9,2.2c-2.4,0-4.5-0.6-6.4-1.9c-1.8-1.3-3.1-2.9-3.9-5l4-1.7
